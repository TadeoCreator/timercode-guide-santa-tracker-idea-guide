# README 
Our TimerCode Purposes is make or show how to you make a example from how and why to create a santa tracker for you. example tracker file on:
- guide.html
# Guide MD
...
```
<!DOCTYPE html>
<script defer apikey npm="https://www.mysanta.site/YOUR_API_KEY123"></script>
```
To Spawn a defer code enter on:
Your Html - example.html(example)
```
<!DOCTYPE html
<script defer apikey npm="https://www.mysanta.site/YOUR_API_KEY123"></script><script src="https://cesium.com/downloads/cesiumjs/releases/1.120/Build/Cesium/Cesium.js"></script>
<link href="https://cesium.com/downloads/cesiumjs/releases/1.120/Build/Cesium/Widgets/widgets.css" rel="stylesheet">
<style>
html, body, #cesiumContainer {width:100%;height:100%;margin:0;padding:0;overflow:hidden;}
body {background: url('YOUR_BACKGROUND.jpg') no-repeat center center/cover;}
...
// Función original para cargar ciudades de respaldo (si la API falla o no es Navidad)
...
async function startTracker(){
    ...
    try {
        ...
        const apiUrl = 'https://www.mysanta.site/YOUR_API_KEY123';
        ...
        if (apiJson.destinations && apiJson.destinations.length > 0) {
            ...
            console.log("API vacía (fuera de temporada), usando datos simulados.");
    ...
    if (usingRealApi) {
        ...
        // Ajustar el reloj de Cesium para que coincida con el último punto conocido o el actual
        ...
        let totalTime = 0;
        const secondsBetweenCities = 10; // Un poco más lento para apreciar
